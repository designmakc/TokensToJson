...
Гео пишется в `$extensions['tokens-to-json'].gradient`, `$value` остаётся чистым DTCG (только стопы):
...
- градиенты: `figmaStyleId` внутри `$extensions['tokens-to-json'].gradient`
